...
public class BeatCharacterModCardPool : CustomCardPoolModel
{
    public override string Title => BeatCharacterMod.CharacterId; //This is not a display name.
    ...
    public override float V => 1.75f; //Brightness

    //Alternatively, leave these values at 1 and provide a custom frame image.
    /*public override Texture2D CustomFrame(CustomCardModel card)
    {
        //This will attempt to load BeatCharacterMod/images/cards/frame.png
